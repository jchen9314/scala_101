...
// Use Spark to read in the Ecommerce Customers csv file. Drop Null values
val data = spark.read.option("header", "true").option("inferSchema","true").format("csv").load("../data/Ecommerce Customers").na.drop()
